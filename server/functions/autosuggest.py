...
def get_suggestions(word_list, prefix, max_suggestions=5):
    """Get suggestions for a given prefix."""
    auto = Autosuggestion(word_list)
    return auto.suggest(prefix, max_suggestions)
...
def main():
    ...
    # Test cases
    test_prefixes = ["resear", "resea", "neur"]
